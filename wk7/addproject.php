...
<?php
    ...
    $results = '';
     if (isPostRequest()){
            ...
            $results = addProject ($projectName, $projectManager);
...
<form method ="post" action="prototype_main.php">
    Project Name</br> <input type="text" value="" name="projectName"/>
    <br />
    Project Manager <br /> <input type="text" value="" name="owner" />
    <br />
