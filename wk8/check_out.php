...
//            var_dump($_SERVER);die();
            ...
            if (isPostRequest()) 
                {
                    ...
                    $stmt = $db->prepare("UPDATE projects SET projectCheckOut = now() WHERE id = :id");
    ...
    //                    ":projectDuration" => $projectDuration
                    ...
                    {
                       $result = 'Project: '.$projectName.' Has Checked Out';
                    } 
                } 
                else 
                {
...
<!--        <div> <h1 style="text-align: center; margin-top: 4%; text-decoration: underline">Check In </h1></div>-->
        ...
        <form style="margin-left: 5%" method="post" action="#">       
            <h1 style=" text-decoration: underline">Project Check Out</h1>
